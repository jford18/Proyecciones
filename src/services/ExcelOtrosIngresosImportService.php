...
class ExcelOtrosIngresosImportService
{
    ...
    {
        $parsed = $this->parseOtrosIngresos($fileTmpPath, $anioRequest, $originalFileName, $clienteSeleccionado ?? '');
    ...
    private function parseOtrosIngresos(string $fileTmpPath, ?int $anioRequest = null, ?string $originalFileName = null, ?string $clienteSeleccionado = null): array
    {
        $reader = new Xlsx();
