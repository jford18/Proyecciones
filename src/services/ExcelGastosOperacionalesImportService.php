...
class ExcelGastosOperacionalesImportService
{
    ...
    {
        $parsed = $this->parseGastosOperacionales($fileTmpPath, $anioRequest, $originalFileName);
    ...
    private function parseGastosOperacionales(string $fileTmpPath, ?int $anioRequest = null, ?string $originalFileName = null): array
    {
        $reader = new Xlsx();
