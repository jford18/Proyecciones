...
class ExcelCostosImportService
{
    ...
    {
        $parsed = $this->parseCostos($fileTmpPath, $anioRequest, $originalFileName);
    ...
    private function parseCostos(string $fileTmpPath, ?int $anioRequest = null, ?string $originalFileName = null): array
    {
        $reader = new Xlsx();
