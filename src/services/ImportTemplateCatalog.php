...
class ImportTemplateCatalog
{
    ...
    public function templates(): array
    {
        return [
            ...
            ['id' => 'eeff_reales_eri', 'label' => 'EEFF Reales ERI', 'sheet_name' => 'ERI', 'columns' => ['CODIGO','DESCRIPCION','ENERO','FEBRERO','MARZO','ABRIL','MAYO','JUNIO','JULIO','AGOSTO','SEPTIEMBRE','OCTUBRE','NOVIEMBRE','DICIEMBRE','TOTAL']],
        ];
    }
