...
<div class="row g-3">
  <div class="col-md-3"><div class="card shadow-sm"><div class="card-body"><h6>Proyecto activo</h6><div class="display-6"><?= $activeProjectId ?></div></div></div></div>
  <div class="col-md-3"><div class="card shadow-sm"><div class="card-body"><h6>Archivo activo</h6><div><?= $activeFile ? htmlspecialchars(basename((string) $activeFile)) : 'No seleccionado' ?></div></div></div></div>
  <div class="col-md-3"><div class="card shadow-sm"><div class="card-body"><h6>Anexos hoy</h6><div class="display-6"><?= (int) $counts['today'] ?></div></div></div></div>
  <div class="col-md-3"><div class="card shadow-sm"><div class="card-body"><h6>Anexos total</h6><div class="display-6"><?= (int) $counts['total'] ?></div></div></div></div>
</div>
...
<div class="d-flex flex-wrap gap-2">
  <a href="?r=upload" class="btn btn-outline-primary">Subir Excel</a>
